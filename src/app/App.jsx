...
import { Layout, PageWrap, Topbar, Card } from '../components'

const Placeholder = ({ title }) => (
  <Layout>
    <PageWrap>
      <Topbar title={title} subtitle="Próximamente" />
      <Card>
        <p style={{ fontSize: 14, color: '#888', textAlign: 'center', padding: '32px 0' }}>
          Este módulo se activa en la próxima versión.
        </p>
      </Card>
    </PageWrap>
  </Layout>
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/config"         element={<P roles={['admin']}><Placeholder title="Configuración" /></P>} />
